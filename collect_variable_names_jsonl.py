...
def main(args):
    ...
    DATASET = args[0]
    if DATASET in {'csn_java', 'github_java_funcs', 'mbjp', 'javatest', 'javagoogle', 'srcgoogle', 'srcgoogle_6b', 'srctest',
                   't4bI', 't4bII', 't6bI', 't6bII', 't6bI_II', 't8bI', 't8bII', 't8bI_II',
                   'st4bI', 'st4bII', 'st6bI', 'st6bII', 'st6bI_II', 'st8bI', 'st8bII', 'st8bI_II',
                   't4III50',
                   't425', 't450', 't475', 't4100', 'st425', 'st450', 'st475', 'st4100',}:
        LANG = 'java'
    ...
    if DATASET in {'mbjsp', 'mbjp', 'mbcpp', 'javatest', 'javagoogle', 'srcgoogle', 'srcgoogle_6b', 'srctest',
                   't4bI', 't4bII', 't6bI', 't6bII', 't6bI_II', 't8bI', 't8bII', 't8bI_II',
                   'st4bI', 'st4bII', 'st6bI', 'st6bII', 'st6bI_II', 'st8bI', 'st8bII', 'st8bI_II',
                   't4III50',
                   't425', 't450', 't475', 't4100', 'st425', 'st450', 'st475', 'st4100',}:
